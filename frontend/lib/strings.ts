...
export const strings = {
  ...
  weights: {
    ...
    submit: "Registrar pesaje",
    submitting: "Registrando...",
    success: "Pesaje registrado correctamente.",
    error: "No se pudo registrar el pesaje.",
    loadError: "No se pudieron cargar los registros.",
    empty: "Aún no hay registros de pesaje.",
    history: "Historial de pesajes",
    plasticTypes: {
      pet: "PET",
      hdpe: "HDPE",
      pp: "PP",
  ...
  collectionRoute: {
    title: "Pasada en ruta",
    start: "Iniciar pasada en ruta",
